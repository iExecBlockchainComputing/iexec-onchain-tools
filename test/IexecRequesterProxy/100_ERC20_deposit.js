...
contract('IexecRequesterProxy - Deposit', async (accounts) => {
	...
	it("Proxy Deposit - success", async () => {
		...
		await IexecRequesterProxyInstance.deposit(rlc_deposit, { from: iexecAdmin, gas: constants.AMOUNT_GAS_PROVIDED });
	...
	it("Proxy Deposit - failure (not approved)", async () => {
		...
		await shouldFail.reverting(IexecRequesterProxyInstance.deposit(rlc_deposit, { from: iexecAdmin, gas: constants.AMOUNT_GAS_PROVIDED }));
	...
	it("Proxy Deposit - failure (not authorized)", async () => {
		...
		await shouldFail.reverting(IexecRequesterProxyInstance.deposit(rlc_deposit, { from: user, gas: constants.AMOUNT_GAS_PROVIDED }));
